...
public class AddNewContact extends AppCompatActivity {
    ...
    private TextInputLayout company;    private TextInputLayout note;
    ...
    public static Intent newIntent(Context packageContext) {
        Intent intent = new Intent(packageContext, AddNewContact.class);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneNo = (TextInputLayout) findViewById(R.id.text_input_phoneNo);
        ...
        note = (TextInputLayout)findViewById(R.id.text_input_note);
        firstName = (TextInputLayout)findViewById(R.id.text_input_firstname);
        lastName = (TextInputLayout)findViewById(R.id.text_input_lastname);
        ...
        company = (TextInputLayout)findViewById(R.id.text_input_company);
    ...
    public void onSaveContact(View view) {
        if(!validateEmail() | !validateFirstName() | !validateLastName() | !validatePhoneNumber()){
           ...
           if(db.addContactDetail(contact) != -1){
